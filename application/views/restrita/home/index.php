                  ...
                  <div class="row">
                      ...
                      <div class="col-auto">
                        <div class="card-circle bg-red text-white">
                          <i class="fas fa-strikethrough p-4"></i>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-lg-6">
                <div class="card">
                  ...
                  <div class="row">
                      ...
                      <div class="col-auto">
                        <div class="card-circle bg-teal text-white">
                          <i class="fas fa-money-bill-alt p-4"></i>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="<?php echo base_url('public/assets/img/banner/2.png'); ?>" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="<?php echo base_url('public/assets/img/banner/3.png'); ?>" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Pagamentos via transferencia</h5>
                          <h2 class="mb-3 font-28"><?php echo $pagamentos_transferencia; ?></h2>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                        <img src="<?php echo base_url('public/assets/img/banner/4.png'); ?>" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
