                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="li-product-name" style="font-size: 14px"><?php echo formata_data_banco_com_hora($pedido->pedido_data_cadastro); ?></td>
                                    <td class="li-product-name" style="font-size: 14px"><?php echo word_limiter($pedido->produto_nome, 5); ?></td>
                                    <td class="li-product-name" style="font-size: 14px">
                            ...
                            <?php $i++; //incrementando o contador ?>
            ...
            <div class="container text-center">
                <img width="35%" src="<?php echo base_url('public/web/images/sem_pedidos.svg'); ?>" alt="">
            </div>
