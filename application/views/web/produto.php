                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <p class="mt-10"><span class="product-details-ref">Estoque:&nbsp;<?php echo ($produto->produto_quantidade_estoque > 0 ? $produto->produto_quantidade_estoque : 'Indisponivel'); ?></span></p>
                                     ...
                                     ?>
                                       ...
                                       <?php echo form_open('carrinho', $atributos); ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <button class="add-to-cart bg-danger" type="button">Indisponivel</button>
                                                </div>
