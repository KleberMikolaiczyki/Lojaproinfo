                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="<?php echo base_url('/'); ?>">
                                        <img src="<?php echo base_url('public/web/images/menu/logo/5.jpg'); ?>" style="height:50px" alt="">
                                    </a>
                                </div>
                            </div>
                                                ...
                                                <?php if($this->carrinho_compras->get_total_itens() > 0): ?>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url('produto/'. $produto['produto_meta_link']); ?>" class="minicart-product-image">
                                                            <img src="<?php echo base_url('uploads/produtos/small/' . $produto['produto_foto']); ?>" alt="<?php $produto['produto_nome']; ?>">
                                                        </a>
