                                    ...
                                    <div class="alert alert-success bg-success alert-has-icon alert-dismissible show fade">
                            ...
                            <div class="login-form">
                                    ...
                                    <input type="text" name="cliente_telefone_fixo" class="form-control sp_celphones mb-0" value="<?php echo (isset($cliente) ? $cliente->cliente_telefone_fixo : set_value('cliente_telefone_fixo')); ?>">
...
<div class="country-select clearfix">
    ...
    <?php if (isset($cliente)): ?>
        ...
        <select class="" name="cliente_estado" 
        style="
        width: 100%;
    ...
    <?php else: ?>
        ...
        <select class="" name="cliente_estado" style="
    width: 100%;
    background-color: transparent;
    border: 1px solid #999999;
    border-radius: 0;
