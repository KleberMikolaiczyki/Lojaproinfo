...
class Carrinho extends CI_Controller
{
    ...
    public function insert()
    {
        ...
        if (!$produto_id || $produto_quantidade < 1) {
            ...
            //Continua o processamento.... verificamos a existência do produto
        ...
        if ($produto_quantidade == "" || $produto_quantidade < 1) {
            ...
            if (!$produto = $this->core_model->get_by_id('produtos', array('produto_id' => $produto_id))) {
                ...
                if ($produto_quantidade > $produto->produto_quantidade_estoque) {
                    ...
                    ///Suscesso.... atualiza a quantidade do item no carrinho, pois há estoque suficiente
    ...
    public function calcula_frete()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            if (isset($resultado->erro)) {
                ...
                echo json_encode($retorno); //Adicione essa linha
                    exit(); //Adicione essa linha
            } else {
                $retorno['erro'] = 0;
            ...
            if ($consulta->cServico[0]->Valor == '0,00') {
                ...
                //Recuperando o valor total dos produtos do carrinho para somar à variável $valor_calculado dentro do foreach
